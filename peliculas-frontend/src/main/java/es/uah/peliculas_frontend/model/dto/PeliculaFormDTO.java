...
public class PeliculaFormDTO {
    ...
    // Para renderizado limpio en la vista
    ...
    public List<Long> getActoresIds() { return actoresIds; }
    public void setActoresIds(List<Long> actoresIds) { this.actoresIds = actoresIds; }
